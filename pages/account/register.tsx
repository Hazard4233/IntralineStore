    ...
    return (
        <div>
            ...
            <div className="my-auto mx-auto w-1/4">
                    ...
                    <button className="custom_letter_space mt-8 uppercase bg-c_00090D text-white py-4 w-full text-sm">Register</button>
                    <div className="text-center mt-5">
                        <Link href="/account/login">
                            <span className="line_hei_px_26 text-base underline">Already have an account?</span>
                        </Link>
                    </div>
                </div>
